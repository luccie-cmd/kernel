# 0 "libcxx/stdio/snprintf.cc"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "libcxx/stdio/snprintf.cc"
...
# 3 "libcxx/stdio/snprintf.cc" 2


# 4 "libcxx/stdio/snprintf.cc"
extern "C" int snprintf(char *s, size_t maxlen, const char *format, ...){
    va_list args;
    
# 6 "libcxx/stdio/snprintf.cc" 3
   __builtin_va_start(
# 6 "libcxx/stdio/snprintf.cc"
   args
# 6 "libcxx/stdio/snprintf.cc" 3
   ,
# 6 "libcxx/stdio/snprintf.cc"
...
# 8 "libcxx/stdio/snprintf.cc" 3
   __builtin_va_end(
# 8 "libcxx/stdio/snprintf.cc"
   args
# 8 "libcxx/stdio/snprintf.cc" 3
   )
# 8 "libcxx/stdio/snprintf.cc"
